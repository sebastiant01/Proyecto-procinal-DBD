...
-- -----------------------------------------------------------------------------
-- 5. SALA
-- Ahora incluye id_empleado para la relación 1:1 EncargadoDe
-- Cada sala se asigna a un empleado del mismo punto de venta
-- -----------------------------------------------------------------------------
INSERT INTO Sala (id_sala, numero_sala, id_punto_venta, id_empleado) 
VALUES
    -- Salas 2D (id_sala 1-20) — asignadas a empleados pares (cajeros/operadores)
    ( 1, 1,  1,  2), ( 2, 1,  2,  4), ( 3, 1,  3,  6), ( 4, 1,  4,  8), ( 5, 1,  5, 10),
    ( 6, 1,  6, 12), ( 7, 1,  7, 14), ( 8, 1,  8, 16), ( 9, 1,  9, 18), (10, 1, 10, 20),
    (11, 1, 11, 22), (12, 1, 12, 24), (13, 1, 13, 26), (14, 1, 14, 28), (15, 1, 15, 30),
    (16, 1, 16, 32), (17, 1, 17, 34), (18, 1, 18, 36), (19, 1, 19, 38), (20, 1, 20, 40),

    -- Salas 3D (id_sala 21-40) — asignadas a administradores
    (21, 2,  1,  1), (22, 2,  2,  3), (23, 2,  3,  5), (24, 2,  4,  7), (25, 2,  5,  9),
    (26, 2,  6, 11), (27, 2,  7, 13), (28, 2,  8, 15), (29, 2,  9, 17), (30, 2, 10, 19),
    (31, 2, 11, 21), (32, 2, 12, 23), (33, 2, 13, 25), (34, 2, 14, 27), (35, 2, 15, 29),
    (36, 2, 16, 31), (37, 2, 17, 33), (38, 2, 18, 35), (39, 2, 19, 37), (40, 2, 20, 39),

    -- Salas VIP (id_sala 41-60) — sin empleado asignado (NULL)
    (41, 3,  1, NULL), (42, 3,  2, NULL), (43, 3,  3, NULL), (44, 3,  4, NULL), (45, 3,  5, NULL),
    (46, 3,  6, NULL), (47, 3,  7, NULL), (48, 3,  8, NULL), (49, 3,  9, NULL), (50, 3, 10, NULL),
    (51, 3, 11, NULL), (52, 3, 12, NULL), (53, 3, 13, NULL), (54, 3, 14, NULL), (55, 3, 15, NULL),
    (56, 3, 16, NULL), (57, 3, 17, NULL), (58, 3, 18, NULL), (59, 3, 19, NULL), (60, 3, 20, NULL);

-- -----------------------------------------------------------------------------
-- 6. SALAS ESPECIALIZADAS (2D, 3D, VIP)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 8. PELICULA
-- Ahora incluye id_director (FK) — relación 1:N según MR optimizado
-- -----------------------------------------------------------------------------
INSERT INTO Pelicula (id_pelicula, titulo, genero, duracion, id_director) 
VALUES
    ( 1, 'Inception',                'Ciencia Ficción', 148,  1),
    ( 2, 'Interstellar',             'Ciencia Ficción', 169,  1),
    ( 3, 'Jurassic Park',            'Aventura',        127,  2),
    ( 4, 'Schindler''s List',        'Drama',           195,  2),
    ( 5, 'Pulp Fiction',             'Thriller',        154,  3),
    ( 6, 'Django Unchained',         'Western',         165,  3),
    ( 7, 'The Departed',             'Crimen',          151,  4),
    ( 8, 'Avatar',                   'Ciencia Ficción', 162,  5),
    ( 9, 'Gladiator',                'Acción',          155,  6),
    (10, 'Blade Runner 2049',        'Ciencia Ficción', 164,  7),
    (11, 'Dune',                     'Ciencia Ficción', 155,  7),
    (12, 'El laberinto del fauno',   'Fantasía',        118,  8),
    (13, 'Roma',                     'Drama',           135,  9),
    (14, 'Parásitos',                'Thriller',        132, 10),
    (15, 'Volver',                   'Drama',           121, 11),
    (16, 'Birdman',                  'Comedia',         119, 12),
    (17, 'El Padrino',               'Crimen',          175, 13),
    (18, 'Se7en',                    'Thriller',        127, 15),
    (19, 'The Grand Budapest Hotel', 'Comedia',         100, 16),
    (20, 'El club de la pelea',      'Thriller',        139, 15),
    (21, 'Requiem for a Dream',      'Drama',           102, 20),
    (22, 'Beetlejuice',              'Comedia',          92, 17);
...
-- -----------------------------------------------------------------------------
-- 11. SERVICIO VIP (sin FK a PuntoVenta)
-- -----------------------------------------------------------------------------
INSERT INTO ServicioVIP (id_servicio, nombre_servicio) 
VALUES
    ( 1, 'Butacas reclinables'),
    ( 2, 'Servicio de mesero'),
    ( 3, 'Menú gourmet'),
    ( 4, 'Sonido Dolby Atmos'),
    ( 5, 'Pantalla 4K OLED'),
    ( 6, 'Cocteles con alcohol'),
    ( 7, 'Manta y almohada'),
    ( 8, 'Minibar en butaca'),
    ( 9, 'Estacionamiento VIP'),
    (10, 'Check-in preferencial'),
    (11, 'WiFi exclusivo'),
    (12, 'Snacks premium'),
    (13, 'Sala de espera privada'),
    (14, 'Iluminación ambiental'),
    (15, 'Temperatura personalizada'),
    (16, 'Cargador inalámbrico en butaca'),
    (17, 'Silla de masajes'),
    (18, 'Auriculares cancelación de ruido'),
    (19, 'Cocteles sin alcohol'),
    (20, 'Acceso a sala de juegos pre-función');

-- -----------------------------------------------------------------------------
-- 12. SALA_SERVICIO (relación N:M entre SalaVIP y ServicioVIP)
-- Cada sala VIP ofrece un conjunto de servicios
-- -----------------------------------------------------------------------------
INSERT INTO SalaServicio (id_sala, id_servicio) 
VALUES
    (41,  1), (41,  2), (41,  4),
    (42,  1), (42,  3), (42,  5),
    (43,  1), (43,  2), (43,  3), (43,  4),
...
-- -----------------------------------------------------------------------------
-- 13. PROTAGONIZA (RELACIÓN PELICULA - ACTOR)
-- -----------------------------------------------------------------------------
